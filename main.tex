...
\begin{abstract}
  ...
  vollständig untergraben wird. Symmetrische Algorithmen wie AES sind zwar resistenter 
  gegenüber Angriffen durch Quantencomputer, jedoch führt der Einsatz des Grover-Algorithmus 
  zu einer quadratischen Reduktion der Sicherheit, was eine Anpassung der Schlüsselgrößen 
  erforderlich macht, um die Integrität des Systems zu gewährleisten.
  Der Beitrag erklärt detailliert die Funktionsweise von Shor’s Algorithmus, der auf der 
  ...
  Die Ergebnisse verdeutlichen, dass Quantencomputer nicht nur bestehende Verschlüsselungsverfahren 
  gefährden, sondern auch die Notwendigkeit eines Paradigmenwechsels in der Kryptografie einleiten. 
\end{abstract}
...
\input{sections/Daniel/section.tex}
\input{sections/paul/section.tex}
\input{sections/matheo/section.tex}
